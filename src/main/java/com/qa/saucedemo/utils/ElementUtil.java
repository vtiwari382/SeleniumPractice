...
public class ElementUtil {
	...
	public void getelementstext(By locator) {
		...
		for(WebElement e:text) {
			System.out.println("getelements showing texts on the page:" +e.getText());
		}
	}
	...
	public void getDropDownValueWithoutSelectClass(By locator) {
		List<WebElement> optionsList = getElements(locator);

		for (WebElement e : optionsList) {

			String text = e.getText();
			System.out.println("options available in dropdown are: " +text);
			}
